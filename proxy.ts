...
function buildCsp(nonce: string): string {
  ...
  return [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://*.sanity.io https://lh3.googleusercontent.com https://*.supabase.co https://va.vercel-scripts.com https://vitals.vercel-insights.com https://api.aladhan.com",
