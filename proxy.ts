...
function buildCsp(nonce: string): string {
  ...
  return [
    ...
    "img-src 'self' data: blob: https://cdn.sanity.io https://lh3.googleusercontent.com https://api.qrserver.com",
    "font-src 'self' data:",
    "connect-src 'self' https://*.sanity.io https://lh3.googleusercontent.com https://*.supabase.co https://va.vercel-scripts.com https://vitals.vercel-insights.com https://api.aladhan.com https://api.qrserver.com",
