        ...
        {displayedArticles.map((article, index) => (
          ...
          >
            <TransitionLink
              ...
              className="group flex h-full overflow-visible rounded-xl border-2 border-forest-600 dark:border-lime bg-white dark:bg-gray-900 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.01] active:scale-[0.99] focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-lime dark:focus-visible:outline-lime hover:outline-2 hover:-outline-offset-1 hover:outline-lime dark:hover:outline-lime"
            >
