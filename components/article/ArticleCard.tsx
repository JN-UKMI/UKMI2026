...
export function ArticleCard({ article }: ArticleCardProps) {
  ...
  return (
    <TransitionLink
      ...
      className="group flex flex-col h-full flex-1 bg-white rounded-xl border border-gray-200 hover:border-4 hover:border-lime hover:shadow-md transition-all duration-300 overflow-hidden"
    >
