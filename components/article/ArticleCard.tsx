      ...
      >
        ...
        <div className="flex flex-col flex-1 p-6 justify-between">
          ...
          <div>
            ...
            <div className="w-full text-center py-2.5 px-4 rounded-full bg-forest-600 group-hover:bg-forest-800 dark:bg-lime dark:group-hover:bg-lime/90 text-white dark:text-forest-950 text-xs font-bold transition-all duration-300 flex items-center justify-center gap-1.5 shadow-sm">
