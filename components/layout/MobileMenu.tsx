...
export function MobileMenu({
  ...
  return (
    <motion.div
      ...
      className="md:hidden absolute top-full left-4 right-4 z-50 mt-2 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200/90 dark:border-gray-800 overflow-hidden p-3 transition-colors"
    >
