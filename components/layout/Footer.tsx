        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              {/* YouTube */}
              <a
                href="https://youtube.com/@jnukmitv"
                target="_blank"
                rel="noopener noreferrer"
                ...
                aria-label="YouTube JN UKMI TV"
                title="YouTube JN UKMI TV"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Spotify */}
              <a
                href="https://open.spotify.com/show/hearmeukmi"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* TikTok */}
              <a
                href="https://tiktok.com/@jnukmitv"
                target="_blank"
                rel="noopener noreferrer"
                ...
                aria-label="TikTok JN UKMI TV"
                title="TikTok JN UKMI TV"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
